...
class testCommRequest final :
 ...
 public:
  ...
  explicit constexpr testCommRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class testCommResponse final :
 ...
 public:
  ...
  explicit constexpr testCommResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void testCommResponse::set_more_info(ArgT0&& arg0, ArgT... args) {
 ...
 more_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& testCommResponse::_internal_more_info() const {
  return more_info_.Get();
}
inline void testCommResponse::_internal_set_more_info(const std::string& value) {
  
  more_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* testCommResponse::_internal_mutable_more_info() {
  
  return more_info_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* testCommResponse::release_more_info() {
  // @@protoc_insertion_point(field_release:testCommResponse.more_info)
  return more_info_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void testCommResponse::set_allocated_more_info(std::string* more_info) {
  ...
  more_info_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), more_info,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (more_info_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
